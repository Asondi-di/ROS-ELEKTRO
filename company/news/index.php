...
$APPLICATION->SetPageProperty("description", "На этой странице Вы можете ознакомиться с новостями компании РОС-ЭЛЕКТРО");
$APPLICATION->SetPageProperty("title", "Новости — РОС-ЭЛЕКТРО");

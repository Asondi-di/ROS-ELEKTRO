...
$APPLICATION->SetPageProperty("description", "На этой странице Вы можете ознакомиться с выгодными условиями и акциями интернет-магазина РОС-ЭЛЕКТРО.");
$APPLICATION->SetPageProperty("title", "Акции интернет магазина РОС-ЭЛЕКТРО");

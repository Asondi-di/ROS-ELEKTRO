...
if(false):
	...
	$arResult['CAPTCHA_CODE'] = $cpt->GetCodeCrypt();
endif;
...
<!--										<label for="FORGOTPASSWD_CAPTCHA"><span>--><?php //=GetMessage('CAPTCHA_PROMT')?><!--&nbsp;<span class="star">*</span></span></label>-->
<!--										<div class="captcha_image">-->
<!--											<img src="/bitrix/tools/captcha.php?captcha_sid=--><?php //=$arResult['CAPTCHA_CODE']?><!--" border="0" />-->
<!--											<input type="hidden" name="captcha_sid" value="--><?php //=$arResult['CAPTCHA_CODE']?><!--" />-->
<!--											<div class="captcha_reload">--><?php //=GetMessage('RELOAD')?><!--</div>-->
<!--										</div>-->
									...
									<div class="line-block line-block--column line-block--align-flex-start line-block--24-vertical">
										...
										<div class="line-block__item width100">
											...
											<?else:?>
												...
												<!--noindex--><a href="/sotrudnichestvo/registration/?register=yes&backurl=/" rel="nofollow" class="btn btn-transparent-border-color btn-lg pull-right register" tabindex="6"><?=GetMessage('AUTH_REGISTER_NEW')?></a><!--/noindex-->
											<?endif;?>
										</div>
									</div>

								...
								<div class="text">
									...
									<?ob_start();?>
										<div class="buttons">
											...
											<?endif;?>
											<?if(isset($arResult['DISPLAY_PROPERTIES']['URL2']) && strlen($arResult['DISPLAY_PROPERTIES']['URL2']['VALUE'])):?>
												<a class="btn <?=(!$bNoImg ? 'btn-default' : 'btn-transparent-border-color');?>" href="<?=str_replace('//', '/', SITE_DIR.'/'.$arResult['DISPLAY_PROPERTIES']['URL2']['VALUE']);?>"><span>Контакты</span></a>
											<?endif;?>
										</div>

		...
		<div class="contacts maxwidth-theme" itemscope itemtype="http://schema.org/Organization">
			<div class="my_row">
				...
				<?if($bHasSections):?>
							...
							<div class="col-md-4 col-sm-6 ask_button text-right" style="    margin-right: 50px;">
							<span>
								<span class="btn  btn-transparent-border-color white  animate-load" data-event="jqm" data-param-form_id="ASK" data-name="contacts"><?//=Loc::getMessage('S_ASK_QUESTION');?>Отправить заявку на быстрый просчёт</span>
							</span>
						</div>
				...
				<?endif;?>
						...
						<div class="col-md-4 col-sm-6 print-6">
							<?CMax::showContactPhones('Отдел продаж', true, '', 'Phone_black2.svg', 'grey');?>
						</div>
						<div class="col-md-4 col-sm-6 print-6">

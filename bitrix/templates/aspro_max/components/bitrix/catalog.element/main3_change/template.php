										...
										<div class="text-form-info">
											<span>
                                                <span class="animate-load dotted"
                                                    ...
                                                    <?=($arParams["SEND_GIFT_FORM_NAME"] ?: GetMessage("SEND_GIFT_FORM"));?>
                                                </span>
                                            </span>
										</div>
									</div>
							...
							<?if($arResult['TIMESTAMP_X']):?>
								<div class="text-form">
									<div class="price_txt muted777 font_sxs muted ncolor spinner-fix">
										<?=CMax::showIconSvg(
                                            "info_big pull-left",
                                            SITE_TEMPLATE_PATH.'/images/svg/catalog/luckru_spinner.svg',
                                            '', '', true, false
                                        );?>
										<div class="text-form-info">
                                            <div id="bx_incl_area_17_1_2_3">Товар обновлен - <?= $arResult['TIMESTAMP_X'] ?><br></div>
										</div>
									</div>
								</div>
							<?endif;?>

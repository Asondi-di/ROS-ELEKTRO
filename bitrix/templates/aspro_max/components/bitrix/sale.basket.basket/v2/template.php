	...
	<div id="basket-root" class="bx-basket bx-<?=$arParams['TEMPLATE_THEME']?> bx-step-opacity" style="opacity: 0;">
		...
		<div class="flexbox flexbox--row basket-items-list">
			<div class="basket-items-list-outer">
                ...
                <? if($storage): ?>
                    <div class="basket-attention-message">
                        <div class="basket-attention-message-icon">!</div>
                        Внимание! В корзине есть товары находящиеся только на региональном складе, поставка товара может занять до 10 рабочих дней.
                    </div>
                <? endif; ?>
